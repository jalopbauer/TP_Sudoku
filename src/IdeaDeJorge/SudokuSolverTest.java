...
class SudokuSolverTest {
    ...
    @Test
    void solveSudoku() {
        NineByNineSudoku nineByNineSudoku = sudoku2ToFill();
        /*nineByNineSudoku.solveSudoku();
        assertTrue(nineByNineSudoku.compare(sudoku2Full()));*/
        nineByNineSudoku = sudoku1ToFill();
        nineByNineSudoku.solveSudoku();
        assertTrue(nineByNineSudoku.compare(sudoku1Full()));
    }

    NineByNineSudoku sudoku1ToFill() {
        NineByNineSudoku sudoku = new NineByNineSudoku();
    ...
    NineByNineSudoku sudoku2ToFill() {
        NineByNineSudoku sudoku = new NineByNineSudoku();
